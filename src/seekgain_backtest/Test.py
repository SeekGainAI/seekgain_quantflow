from seekgain_backtest.main_local import Run
...
def main():
    ...
    #     'risk_control_id': 332,
    # }]
    handle_message = {'file': '/Users/peiqi/code/python/seekgain_workflow/src/seekgain_backtest/strategy/factor02.py',
    # handle_message = {'file': '/Users/peiqi/code/python/seekgain_workflow/src/seekgain_backtest/strategy/ase.py',
                      'run_params': 'no_opz',
