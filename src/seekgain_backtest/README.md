...
> 策略头部需要默认引用内置API，代码为：from seekgain_backtest.api.api import *，后文不再重复赘述。
...
### 事件拓展
> 系统支持自定义事件，详细参考开源代码src/seekgain_backtest/backtest_common/system/event/event.py
...
from seekgain_backtest.api.future_api import *
import pandas as pd
import numpy as np
import copy
import datetime
