...
from seekgain_backtest.backtest_common.data.future.base_future_info_map import BaseFutureInfoMap
import re
...
class FutureInfoMap(BaseFutureInfoMap):
    ...
    def __getitem__(self, key):
        ...
        try:
            ...
            instrument_info =  self.quotation_mongo_db.mongo_find_one(db_name="seekgain",collection_name=collection,query=
