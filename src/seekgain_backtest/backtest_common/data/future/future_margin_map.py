...
from seekgain_backtest.backtest_common.data.future.base_future_margin_map import BaseFutureMarginMap
...
class FutureMarginMap(BaseFutureMarginMap):
    ...
    def get_future_margin_info(self, symbol, trade_date):
        ...
        instrument_info = self.quotation_mongo_db.mongo_find_one(db_name="seekgain",collection_name="future_margin",query=
