...
# @desc   : 股票账户对象
from seekgain_backtest.backtest_common.data.stock.back_test.stock_positions import StockPositions
import logging

from seekgain_backtest.backtest_common.data.stock.base_stock_account import BaseStockAccount
...
class StockAccount(BaseStockAccount):
    ...
    def __getitem__(self, key):
        ...
        raise KeyError(f"'{key}' not found in StockAccount")
