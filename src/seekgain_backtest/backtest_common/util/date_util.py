...
class DateUtil(object):
    ...
    def get_pre_date(cls, trade_date,pre_number=1):
        curr_trade_date_cur = cls._quotation_db.mongo_find_one(db_name="seekgain", collection_name="trading_calendar_all",
                                                               query={
        ...
        pre_trade_date = cls._quotation_db.mongo_find_one(db_name="seekgain", collection_name="trading_calendar_all",
                                                               query={
    ...
    def get_next_trade_date(cls, trade_date,next_number=1):
        ...
        trade_date = cls._quotation_db.mongo_find_one(db_name="seekgain", collection_name="trading_calendar_all",
                                                          query={
                                                              'sort_idx': int(sort_dex),
                                                          })
