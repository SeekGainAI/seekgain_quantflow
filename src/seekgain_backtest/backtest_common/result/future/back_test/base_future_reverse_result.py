...
from seekgain_backtest.backtest_common.util.date_util import DateUtil
from seekgain_backtest.backtest_common.constant.strategy_constant import SIDE_BUY, CLOSE, ACTIVE, CANCELLED, FILLED, REJECTED, OPEN, \
...
from seekgain_backtest.backtest_common.model.result.seekgain_backtest_position import SeekGainBacktestPosition
...
class BaseFutureReverseResult(_MarginRateCacheMixin):
    ...
    def init_data(self):
        ...
        self.xb_back_test_account = SeekGainBacktestAccount()
        ...
        self.xb_back_test_profit = SeekGainBacktestProfit()
        ...
        if trade.direction == OPEN:  # 开仓
            ...
            if trade.business == SIDE_BUY:
                ...
                if trade.contract_code in self.long_position_dict.keys():
                    ...
                    xb_back_test_position = SeekGainBacktestPosition()
