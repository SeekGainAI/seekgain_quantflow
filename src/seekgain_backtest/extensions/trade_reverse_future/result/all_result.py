...
from seekgain_backtest.extensions.trade_reverse_future.result.fund_reverse_result import FundReverseResult
from seekgain_backtest.extensions.trade_reverse_future.result.result_db import ResultDb
from seekgain_backtest.extensions.trade_reverse_future.result.standard_symbol_result import StandSymbolResult
from seekgain_backtest.backtest_common.result.base_all_result import BaseAllTradeReverseResult
from seekgain_backtest.extensions.trade_reverse_future.result.trade_reverse_result import TradeReverseResult
from seekgain_backtest.extensions.trade_reverse_future.result.future_reverse_result import FutureReverseResult
from seekgain_backtest.util.annotation.singleton_annotation import singleton
from seekgain_backtest.backtest_common.model.result.seekgain_backtest_account import SeekGainBacktestAccount
from seekgain_backtest.backtest_common.model.result.seekgain_backtest_profit import SeekGainBacktestProfit
from seekgain_backtest.extensions.common_api.index_calculate import IndexCalculate
...
class AllTradeReverseResult(BaseAllTradeReverseResult):
    ...
    def save_strategy_account_info(self):
        ...
        self.all_profit = SeekGainBacktestProfit()
        self.all_account = SeekGainBacktestAccount()
