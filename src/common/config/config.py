...
def load_config():
    ...
    config = {}
    # MongoDB
    config["MONGO_USER"] = os.getenv("MONGO_USER", "seekgain")
    config["MONGO_PASSWORD"] = os.getenv("MONGO_PASSWORD", "seekgain")
    config["MONGO_URI"] = os.getenv("MONGO_URI", "127.0.0.1:27017")
    config["MONGO_AUTH_DB"] = os.getenv("MONGO_AUTH_DB", "admin")
    config["MONGO_DB"] = os.getenv("MONGO_DB", "seekgain")
    ...
    config["MYSQL_DATABASE"] = os.getenv("MYSQL_DATABASE", "seekgainai_test")
