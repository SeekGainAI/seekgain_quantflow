...
from seekgain_server.config.env import LOG_FORMAT, LOG_LEVEL, LOG_CONSOLE, LOG_FILE, LOG_CONSOLE_ANSI
...
1. 在 seekgain_server/config/env.py 中配置相关环境变量 (LOG_LEVEL, LOG_CONSOLE, LOG_FILE, LOG_FORMAT 等)
2. 在 seekgain_server/main.py 中配置日志配置: setup_logging()
3. 在项目各个文件中按如下方法使用日志:
    import logging
...
def get_log_config():
        ...
        handlers_config.update(
            {
                "file_debug": {
                    ...
                    "filename": str(log_dir / f"seekgain_debug.log"),
                    "maxBytes": 10485760,
                    "backupCount": 5,
                    "encoding": "utf-8",
                },
                "file_info": {
                    ...
                    "level": "INFO",
                    "formatter": file_formatter,  # 文件日志根据 log_format 选择
                    "filename": str(log_dir / f"seekgain_info.log"),
                    "maxBytes": 10485760,
                    "backupCount": 5,
                    "encoding": "utf-8",
                },
                "file_error": {
                    ...
                    "level": "ERROR",
                    "formatter": file_formatter,  # 文件日志根据 log_format 选择
                    "filename": str(log_dir / f"seekgain_error.log"),
                    "maxBytes": 10485760,
                    "backupCount": 5,
                    "encoding": "utf-8",
                },
    ...
    config = {
        ...
        "loggers": {
            ...
            "seekgain_ml": {"level": log_level, "handlers": handlers, "propagate": False},
            "seekgain_backtest": {
                "level": log_level,
                "handlers": handlers,
                "propagate": False,
