...
from seekgain_backtest.backtest_common.model.result.seekgain_backtest_position import SeekGainBacktestPosition as XbBacktestPosition, SIDE_SELL, PartTradedNotQueueing, \
    CANCELLED, ACTIVE
