...
from seekgain_backtest.api.api import init_sr_logger
...
from seekgain_trading.trading.data.context.strategy_context import StrategyContext
...
class Run(object):
    ...
    def start(handle_message):
        ...
        extension_module = import_module("seekgain_trading.trading.extensions.real_trade")
