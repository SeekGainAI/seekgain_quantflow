...
from seekgain_backtest.backtest_common.constant.string_constant import FUTURE_ACCOUNT_NOT_INIT, CTP_INSERT_ORDER_ERROR, \
    FUTURE_ORDER_ID_NOT_INIT
from seekgain_trading.real_trade_api.ctp.ctp_trade_spi import CTPTraderSpi
from seekgain_trading.real_trade_api.ctp.dur_result import DurResult
from seekgain_trading.real_trade_api.ctp.qry_thread import QryThread
import platform
import ctp as api
