...
from seekgain_server.models.backtest.query_user_strategy_log_response import QueryBacktestUserStrategyLogListResponse, QueryBacktestUserStrategyLogListResponseData

logger = logging.getLogger(__name__)

COLLECTION_NAME = "seekgain_user_strategy_log"
