...
from seekgain_server.models.backtest.query_position_response import QueryBacktestPositionListResponse, QueryBacktestPositionListResponseData
from typing import Optional

logger = logging.getLogger(__name__)

COLLECTION_NAME = "seekgain_backtest_position"
