...
from seekgain_server.models.backtest.query_backtest_response import QueryBacktestResultResponseData, QueryBacktestBacktestResponse
from seekgain_server.models.base_api_response import BaseAPIResponse

logger = logging.getLogger(__name__)

# 定义 collection 名称
COLLECTION_NAME = "seekgain_back_test"
