...
from seekgain_server.models.backtest.query_account_response import QueryBacktestAccountListResponse, QueryBacktestAccountListResponseData

logger = logging.getLogger(__name__)

# 定义 collection 名称
COLLECTION_NAME = "seekgain_backtest_account"
