...
from seekgain_server.models.backtest.query_trade_response import QueryBacktestTradeListResponse, QueryBacktestTradeListResponseData

logger = logging.getLogger(__name__)

COLLECTION_NAME = "seekgain_backtest_trade"
