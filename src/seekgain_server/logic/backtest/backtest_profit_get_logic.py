...
from seekgain_server.models.backtest.query_profit_response import QueryBacktestProfitListResponse, QueryBacktestProfitListResponseData

logger = logging.getLogger(__name__)

COLLECTION_NAME = "seekgain_backtest_profit"
