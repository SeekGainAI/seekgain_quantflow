...
# 运行模式: LOCAL 为用户本地运行, CLOUD 为 SeekGain 官网运行
...
DATABASE_NAME = os.getenv("DATABASE_NAME", "seekgain")
MONGO_USER = os.getenv("MONGO_USER", "seekgain")
MONGO_PASSWORD = os.getenv("MONGO_PASSWORD", "seekgain")
...
SEEKGAIN_SERVER_WORKFLOW_WORKERS = os.getenv("SEEKGAIN_SERVER_WORKFLOW_WORKERS", 5)
