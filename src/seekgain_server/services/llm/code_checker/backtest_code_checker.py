...
from seekgain_server.services.llm.code_checker.base_code_checker import BaseCodeChecker
from seekgain_server.services.llm.code_checker.rules.backtest_code_rules import *
...
class BacktestCodeChecker(BaseCodeChecker):
    ...
    回测代码要求 ref: https://www.seekgainai.online/community/article/117
    """
