...
from seekgain_plugins.utils.work_node_loader import load_all_nodes
from seekgain_server.messaging.consumer_manager import QueueConsumerManager
from seekgain_server.messaging.rabbitmq_client import AsyncRabbitMQ
from seekgain_server.routes import (
    base_routes,
    plugins_routes,
    workflow_routes,
    backtest_route,
...
from seekgain_server.routes.trading import (
    trading_routes,
...
app = FastAPI(
    title="SeekGain QuantFlow API",
    description="SeekGain QuantFlow API",
    version="1.0.0",
    lifespan=lifespan,
)
...
# 获取上一级目录中的另一个文件夹
frontend_folder = parent_dir / "seekgain_web"
